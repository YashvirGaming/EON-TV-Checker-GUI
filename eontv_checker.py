...
class EONChecker:
    def __init__(self, root):
        self.root = root
        self.root.title("Vivacom EON (Bulgarian) Checker | Telegram: @therealyashvirgaming")
                        ...
                        if rtk:
                            ...
                            if r2.status_code == 200 and "access_token" in r2.text:
                                ...
                                if tok2:
                                    ...
                                    self.log(f"[HIT] {line} | AUTHOR Telegram: 🔥 @therealyashvirgaming 🔥")
                                    ...
                                    try:
                                        ...
                                        messagebox.showinfo(
                                            ...
                                            f"Expiry: {expiry_val}\n\n"
                                            f"AUTHOR Telegram: 🔥 @therealyashvirgaming 🔥"
                                        )
                                    except Exception:
                                        pass
                                else:
    ...
    def show_credits(self):
        ...
        try:
            ...
            pass
        tk.Label(credits, text="Made with ♥ by Yashvir Gaming", fg="cyan", bg="black", font=("Arial", 12, "bold")).pack(pady=8)
        link = tk.Label(credits, text="Telegram: https://t.me/therealyashvirgaming", fg="light blue", bg="black", cursor="hand2")
        link.pack(pady=4)
        link.bind("<Button-1>", lambda e: webbrowser.open("https://t.me/therealyashvirgaming"))
        ctk.CTkButton(credits, text="🔥 Subscribe on YouTube 🔥", fg_color="#e11d48", command=lambda: webbrowser.open("https://www.youtube.com/@YashvirBlogger?sub_confirmation=1")).pack(pady=6, padx=8, fill="x")
        ctk.CTkButton(credits, text="🔥 Join Telegram Group 🔥", fg_color="#059669", command=lambda: webbrowser.open("https://t.me/OFFICIALYASHVIRGAMING_GROUPCHAT")).pack(pady=6, padx=8, fill="x")
        ctk.CTkButton(credits, text="🔥 Join Facebook Group 🔥", fg_color="#2563eb", command=lambda: webbrowser.open("https://www.facebook.com/groups/svbconfigsmaker/")).pack(pady=6, padx=8, fill="x")
